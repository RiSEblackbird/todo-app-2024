...
def copy_files(project_root, dest_folder, files_to_copy):
    """
...
def main():
    ...
    copy_files(project_root, normal_dest, normal_files)
    ...
    copy_files(project_root, frontend_dest, frontend_files)
    ...
    copy_files(project_root, backend_dest, backend_files)
